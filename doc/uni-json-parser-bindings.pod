...
by B<data> into an actual string object. The I<work string> may be
NULL or empty. Must dispose of the object pointed to by B<str> if
creation of the actual string succeeded.
