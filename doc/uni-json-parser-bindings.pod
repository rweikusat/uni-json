...
is then supposed to create an actual string object from the collected data in the
I<work string> and disposed of that (insofar necessary).
...
Called to combine the content of the I<work string> object pointed to by B<str> with
a final chunk of UTF-8 data of length B<len> pointed to by B<data> into an actual string
object. The I<work string> may be empty. Must dispose of the object pointed to by
B<str> if creation of the actual string succeeded.
